...
class BaseFmx:
    ...
    op1_output_mode = Controller(CompactRange(0, 31), 0)
    op2_output_mode = Controller(CompactRange(0, 15), 0)
    op3_output_mode = Controller(CompactRange(0, 7), 0)
    op4_output_mode = Controller(CompactRange(0, 3), 0)
