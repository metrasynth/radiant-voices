...
class BaseFmx:
    ...
    class Op1OutputMode(IntEnum):
        ...
        to_output_4_3_2 = 29
        to_5_4_3_2 = 30
        to_output_5_4_3_2 = 31

    class Op2OutputMode(IntEnum):
        none = 0
        to_output = 1
        to_5 = 2
        to_output_5 = 3
    ...
    op1_output_mode = Controller(Op1OutputMode, Op1OutputMode.none)
